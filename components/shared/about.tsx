          ...
          <Link href={"/services"} className="flex flex-row gap-2 p-10">
            ...
            >
              <svg
                ...
                height="50px"
                viewBox="0 0 24 24"
                className=" fill-yellow-300 group-hover group-active:stroke-zinc-200 group-active:fill-black group-active:duration-0 duration-300"
              >
                <path
                  d="M12 22C17.5 22 22 17.5 22 12C22 6.5 17.5 2 12 2C6.5 2 2 6.5 2 12C2 17.5 6.5 22 12 22Z"
                  stroke-width="1"
                ></path>
                <path d="M8 12H16" stroke-width="1" className="stroke-black/60"></path>
                <path d="M12 16V8" stroke-width="1" className="stroke-black/60"></path>
              </svg>
            </button>
