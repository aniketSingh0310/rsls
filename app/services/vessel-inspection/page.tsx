      ...
      <Parallax bgImage={image} strength={-200}>
        <div style={{ height: 700 }}>
          <div className="absolute left-[40%] top-1/2 transform -translate-x-1/2 -translate-y-1/2 gap-1">
            <p className={cn("text-yellow-300 text-3xl", mont.className)}>
              Services
            </p>
            <p
              className={cn(
                "text-white  font-bold md:text-[45px] text-[30px] antialiased tracking-[0.03em] leading-[45px] mt-2",
                mont.className
              )}
            >
              Marine Vessel, Ship And Boat Inspection
            </p>
          </div>
        </div>
      </Parallax>
